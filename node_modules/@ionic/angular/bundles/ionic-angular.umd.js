(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    exports.IonDatetimeButton = /** @class */ (function () {
        function IonDatetimeButton(c, r, z) {
            this.z = z;
            c.detach();
            this.el = r.nativeElement;
        }
    ...
    /** @nocollapse */ exports.IonDatetimeButton.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.10", ngImport: i0__namespace, type: exports.IonDatetimeButton, deps: [{ token: i0__namespace.ChangeDetectorRef }, { token: i0__namespace.ElementRef }, { token: i0__namespace.NgZone }], target: i0__namespace.ɵɵFactoryTarget.Component });
    /** @nocollapse */ exports.IonDatetimeButton.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.10", type: exports.IonDatetimeButton, selector: "ion-datetime-button", inputs: { color: "color", datetime: "datetime", disabled: "disabled", mode: "mode" }, ngImport: i0__namespace, template: '<ng-content></ng-content>', isInline: true, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    exports.IonDatetimeButton = __decorate([
        ProxyCmp({
            defineCustomElementFn: undefined,
            inputs: ['color', 'datetime', 'disabled', 'mode']
        })
    ], exports.IonDatetimeButton);
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.10", ngImport: i0__namespace, type: exports.IonDatetimeButton, decorators: [{
                type: i0.Component,
                args: [{
    ...
    /** @nocollapse */ exports.IonRange.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.10", type: exports.IonRange, selector: "ion-range", inputs: { activeBarStart: "activeBarStart", color: "color", debounce: "debounce", disabled: "disabled", dualKnobs: "dualKnobs", max: "max", min: "min", mode: "mode", name: "name", pin: "pin", pinFormatter: "pinFormatter", snaps: "snaps", step: "step", ticks: "ticks", value: "value" }, ngImport: i0__namespace, template: '<ng-content></ng-content>', isInline: true, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    ...
    /** @nocollapse */ exports.IonToggle.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.10", type: exports.IonToggle, selector: "ion-toggle", inputs: { checked: "checked", color: "color", disabled: "disabled", enableOnOffLabels: "enableOnOffLabels", mode: "mode", name: "name", value: "value" }, ngImport: i0__namespace, template: '<ng-content></ng-content>', isInline: true, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    ...
    var AngularDelegate = /** @class */ (function () {
        ...
        AngularDelegate.prototype.create = function (resolverOrInjector, injector, location, elementReferenceKey) {
    ...
    var AngularFrameworkDelegate = /** @class */ (function () {
        function AngularFrameworkDelegate(resolverOrInjector, injector, location, appRef, zone, elementReferenceKey) {
        ...
        AngularFrameworkDelegate.prototype.attachViewToDom = function (container, component, params, cssClasses) {
            ...
            return this.zone.run(function () {
                return new Promise(function (resolve) {
                    var componentProps = Object.assign({}, params);
                    /**
                     ...
                     */
                    if (_this.elementReferenceKey !== undefined) {
                        componentProps[_this.elementReferenceKey] = container;
                    }
                    var el = attachView(_this.zone, _this.resolverOrInjector, _this.injector, _this.location, _this.appRef, _this.elRefMap, _this.elEventsMap, container, component, componentProps, cssClasses);
                    resolve(el);
                });
            });
        };
    ...
    var IonRouterOutlet = /** @class */ (function () {
        function IonRouterOutlet(parentContexts, location, name, tabs, config, navCtrl, componentFactoryResolver, commonLocation, elementRef, router, zone, activatedRoute, parentOutlet) {
        ...
        IonRouterOutlet.prototype.activateWith = function (activatedRoute, resolverOrInjector) {
            ...
            if (enteringView) {
                ...
                // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                var component = (_a = snapshot.routeConfig.component) !== null && _a !== void 0 ? _a : snapshot.component;
                if (resolverOrInjector && isComponentFactoryResolver(resolverOrInjector)) {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.10", ngImport: i0__namespace, type: IonRouterOutlet, decorators: [{
            ...
            return [{ type: i3__namespace.ChildrenOutletContexts }, { type: i0__namespace.ViewContainerRef }, { type: undefined, decorators: [{
                            ...
                            type: i0.Attribute,
                            args: ['tabs']
                        }] }, { type: Config }, { type: NavController }, { type: i0__namespace.ComponentFactoryResolver, decorators: [{
                            type: i0.Optional
    ...
    /** @nocollapse */ exports.IonModal.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.10", type: exports.IonModal, selector: "ion-modal", inputs: { animated: "animated", keepContentsMounted: "keepContentsMounted", backdropBreakpoint: "backdropBreakpoint", backdropDismiss: "backdropDismiss", breakpoints: "breakpoints", canDismiss: "canDismiss", cssClass: "cssClass", enterAnimation: "enterAnimation", event: "event", handle: "handle", handleBehavior: "handleBehavior", initialBreakpoint: "initialBreakpoint", isOpen: "isOpen", keyboardClose: "keyboardClose", leaveAnimation: "leaveAnimation", mode: "mode", presentingElement: "presentingElement", showBackdrop: "showBackdrop", swipeToClose: "swipeToClose", translucent: "translucent", trigger: "trigger" }, queries: [{ propertyName: "template", first: true, predicate: i0.TemplateRef, descendants: true }], ngImport: i0__namespace, template: "<div class=\"ion-page\" *ngIf=\"isCmpOpen || keepContentsMounted\">\n    <ng-container [ngTemplateOutlet]=\"template\"></ng-container>\n  </div>", isInline: true, directives: [{ type: i1__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i1__namespace.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet"] }], changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    ...
    /** @nocollapse */ exports.IonPopover.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.10", type: exports.IonPopover, selector: "ion-popover", inputs: { alignment: "alignment", animated: "animated", arrow: "arrow", keepContentsMounted: "keepContentsMounted", backdropDismiss: "backdropDismiss", cssClass: "cssClass", dismissOnSelect: "dismissOnSelect", enterAnimation: "enterAnimation", event: "event", isOpen: "isOpen", keyboardClose: "keyboardClose", leaveAnimation: "leaveAnimation", mode: "mode", showBackdrop: "showBackdrop", translucent: "translucent", trigger: "trigger", triggerAction: "triggerAction", reference: "reference", size: "size", side: "side" }, queries: [{ propertyName: "template", first: true, predicate: i0.TemplateRef, descendants: true }], ngImport: i0__namespace, template: "<ng-container [ngTemplateOutlet]=\"template\" *ngIf=\"isCmpOpen || keepContentsMounted\"></ng-container>", isInline: true, directives: [{ type: i1__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i1__namespace.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet"] }], changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    ...
    var ModalController = /** @class */ (function (_super) {
        ...
        ModalController.prototype.create = function (opts) {
            var _a;
            return _super.prototype.create.call(this, Object.assign(Object.assign({}, opts), { delegate: this.angularDelegate.create((_a = this.resolver) !== null && _a !== void 0 ? _a : this.environmentInjector, this.injector, undefined, 'modal') }));
        };
    ...
    var PopoverController = /** @class */ (function (_super) {
        ...
        PopoverController.prototype.create = function (opts) {
            var _a;
            return _super.prototype.create.call(this, Object.assign(Object.assign({}, opts), { delegate: this.angularDelegate.create((_a = this.resolver) !== null && _a !== void 0 ? _a : this.environmentInjector, this.injector, undefined, 'popover') }));
        };
    ...
    var DECLARATIONS = __spreadArray(__spreadArray([], __read(DIRECTIVES)), [
        // manual proxies
        exports.IonModal,
        exports.IonPopover,
        // ngModel accessors
    ...
    /** @nocollapse */ IonicModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.10", ngImport: i0__namespace, type: IonicModule, declarations: [exports.IonAccordion, exports.IonAccordionGroup, exports.IonApp, exports.IonAvatar, exports.IonBackButton, exports.IonBackdrop, exports.IonBadge, exports.IonBreadcrumb, exports.IonBreadcrumbs, exports.IonButton, exports.IonButtons, exports.IonCard, exports.IonCardContent, exports.IonCardHeader, exports.IonCardSubtitle, exports.IonCardTitle, exports.IonCheckbox, exports.IonChip, exports.IonCol, exports.IonContent, exports.IonDatetime, exports.IonDatetimeButton, exports.IonFab, exports.IonFabButton, exports.IonFabList, exports.IonFooter, exports.IonGrid, exports.IonHeader, exports.IonIcon, exports.IonImg, exports.IonInfiniteScroll, exports.IonInfiniteScrollContent, exports.IonInput, exports.IonItem, exports.IonItemDivider, exports.IonItemGroup, exports.IonItemOption, exports.IonItemOptions, exports.IonItemSliding, exports.IonLabel, exports.IonList, exports.IonListHeader, exports.IonMenu, exports.IonMenuButton, exports.IonMenuToggle, exports.IonNav, exports.IonNavLink, exports.IonNote, exports.IonProgressBar, exports.IonRadio, exports.IonRadioGroup, exports.IonRange, exports.IonRefresher, exports.IonRefresherContent, exports.IonReorder, exports.IonReorderGroup, exports.IonRippleEffect, exports.IonRow, exports.IonSearchbar, exports.IonSegment, exports.IonSegmentButton, exports.IonSelect, exports.IonSelectOption, exports.IonSkeletonText, exports.IonSlide, exports.IonSlides, exports.IonSpinner, exports.IonSplitPane, exports.IonTabBar, exports.IonTabButton, exports.IonText, exports.IonTextarea, exports.IonThumbnail, exports.IonTitle, exports.IonToggle, exports.IonToolbar,
            // manual proxies
            exports.IonModal,
            exports.IonPopover,
            // ngModel accessors
            ...
            VirtualHeader,
            VirtualItem,
            exports.IonVirtualScroll], imports: [i1.CommonModule], exports: [exports.IonAccordion, exports.IonAccordionGroup, exports.IonApp, exports.IonAvatar, exports.IonBackButton, exports.IonBackdrop, exports.IonBadge, exports.IonBreadcrumb, exports.IonBreadcrumbs, exports.IonButton, exports.IonButtons, exports.IonCard, exports.IonCardContent, exports.IonCardHeader, exports.IonCardSubtitle, exports.IonCardTitle, exports.IonCheckbox, exports.IonChip, exports.IonCol, exports.IonContent, exports.IonDatetime, exports.IonDatetimeButton, exports.IonFab, exports.IonFabButton, exports.IonFabList, exports.IonFooter, exports.IonGrid, exports.IonHeader, exports.IonIcon, exports.IonImg, exports.IonInfiniteScroll, exports.IonInfiniteScrollContent, exports.IonInput, exports.IonItem, exports.IonItemDivider, exports.IonItemGroup, exports.IonItemOption, exports.IonItemOptions, exports.IonItemSliding, exports.IonLabel, exports.IonList, exports.IonListHeader, exports.IonMenu, exports.IonMenuButton, exports.IonMenuToggle, exports.IonNav, exports.IonNavLink, exports.IonNote, exports.IonProgressBar, exports.IonRadio, exports.IonRadioGroup, exports.IonRange, exports.IonRefresher, exports.IonRefresherContent, exports.IonReorder, exports.IonReorderGroup, exports.IonRippleEffect, exports.IonRow, exports.IonSearchbar, exports.IonSegment, exports.IonSegmentButton, exports.IonSelect, exports.IonSelectOption, exports.IonSkeletonText, exports.IonSlide, exports.IonSlides, exports.IonSpinner, exports.IonSplitPane, exports.IonTabBar, exports.IonTabButton, exports.IonText, exports.IonTextarea, exports.IonThumbnail, exports.IonTitle, exports.IonToggle, exports.IonToolbar,
            // manual proxies
            exports.IonModal,
            exports.IonPopover,
            // ngModel accessors
