...
function extractArgsFromSelectorsDictionary(selectorsDictionary) {
    ...
    const projector = (...selectorResults) => resultKeys.reduce((result, key, index) => (Object.assign(Object.assign({}, result), { [key]: selectorResults[index] })), {});
...
function createFeature(featureConfig) {
    ...
    const baseSelectors = Object.assign({ [`select${capitalize(name)}State`]: featureSelector }, nestedSelectors);
    const extraSelectors = extraSelectorsFactory
        ? extraSelectorsFactory(baseSelectors)
        : {};
    return Object.assign(Object.assign({ name,
        reducer }, baseSelectors), extraSelectors);
}
